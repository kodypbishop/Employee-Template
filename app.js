...
function html(answers){
    ...
    answers.Manager.forEach(element => {
        cards.concat(managerTemplate(element.Manager))
    });
    answers.Engineer.forEach(element => {
        cards.concat(engineerTemplate(element.Engineer))
    });
    answers.Intern.forEach(element => {
        cards.concat(internTemplate(element.Intern))
    });
    mainTemplate(cards);
    fs.writeFile("./output/test.html", mainTemplate(cards), function(err) {
